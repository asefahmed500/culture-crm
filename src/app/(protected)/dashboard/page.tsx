                ...
                {profiles.length > 0 && (
                    <Card>
                        ...
                        <CardContent className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
                             ...
                             <KpiCard key="profiles" title="Total Customer Profiles" value={profiles.length} unit="" icon={Users} />
                             <KpiCard key="segments" title="Generated Segments" value={segments.length} unit="" icon={Milestone} />
                        </CardContent>
                    </Card>
                )}
